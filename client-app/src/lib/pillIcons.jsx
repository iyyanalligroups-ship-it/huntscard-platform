// Small inline icons for the AR component buttons (Call/Portfolio/Social/
// Huntsworld/custom) -- shared between MagicCamera.jsx's live scan and
// MagicBusinessCard.jsx's drag-to-position editor preview, so both render
// the exact same icon for the exact same button. "custom" covers any
// admin-defined attribute (magicComponents/magicComponentDefs) since
// there's no single icon that fits an arbitrary one of those.
export const PILL_ICONS = {
  ...
  social: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="18" cy="5" r="3" /><circle cx="6" cy="12" r="3" /><circle cx="18" cy="19" r="3" /><path d="M8.59 13.51 15.42 17.49M15.41 6.51 8.59 10.49" /></svg>
  ),
  huntsworld: (
